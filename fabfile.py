...
def config_from_git():
    ...
    if ddisearch.__version_info__[-1]:
...
def deploy(path=None, user=None, url_prefix='', remote_proxy=None):
    ...
    Parameters:
      path: base deploy directory on remote host; deploy expects a
            ...
            Default: env.remote_path = /home/httpd/sites/ddisearch
    ...
    Example usage:
      fab deploy:/home/ddisearch/,ddi -H servername
      fab deploy:user=www-data,url_prefix=/ddi -H servername
